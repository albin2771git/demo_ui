/// status : "Success"
/// data : {"id":152,"academicYearId":9,"academicYear":"2022-2023","roleId":5,"role":"Principal","token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..g-CCuevfG4W5O67fIMmm5-jvTsbDb5EuRHxMyBAlxW8","name":"PRAYAGA PRATHEESH","imgUrl":"https://edisapp3storageaccount.blob.core.windows.net/text/9a91e63c-6cb2-4a4b-b8db-841205dfa22967a5a67d-84a3-48db-9dad-0c5bae4dab97.png","designation":"Principal","tempPassword":false,"status":true,"message":"LOGIN_SUCCESS","schoolName":"Eloit Academy, New Delhi","mobileNo":"8921661155","firebaseTopic":"qaedisappnet","otpSendStatus":false,"isTwoFactorAuthenticationEnabled":false}
...
class Datafromapi {
  ...
  Datafromapi.fromJson(dynamic json) {
    _status = json['status'];
    _data = json['data'] != null ? Data.fromJson(json['data']) : null;
  }
  String? _status;
  Data? _data;
Datafromapi copyWith({  String? status,
  Data? data,
}) => Datafromapi(  status: status ?? _status,
  data: data ?? _data,
);
...
/// roleId : 5
/// role : "Principal"
/// token : "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..g-CCuevfG4W5O67fIMmm5-jvTsbDb5EuRHxMyBAlxW8"
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    _isTwoFactorAuthenticationEnabled = json['isTwoFactorAuthenticationEnabled'];
  }
  num? _id;
  num? _academicYearId;
...
Data copyWith({  num? id,
  ...
  isTwoFactorAuthenticationEnabled: isTwoFactorAuthenticationEnabled ?? _isTwoFactorAuthenticationEnabled,
);
  num? get id => _id;
  ...
  bool? get isTwoFactorAuthenticationEnabled => _isTwoFactorAuthenticationEnabled;
